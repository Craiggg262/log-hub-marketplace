    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-background silk-gradient p-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-md space-y-8 relative z-10">
        ...
        <div className="text-center space-y-3">
          <img src={logoImage} alt="Log Hub" className="h-20 w-20 rounded-2xl mx-auto" />
          <h1 className="text-3xl font-bold text-gradient">Log Hub</h1>
          <p className="text-sm text-muted-foreground">Premium Logs Marketplace</p>
        </div>
          ...
          <div className="p-6 space-y-5">
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <Button
                type="button"
                variant="outline"
                className="w-full h-12 rounded-xl glass-button border-border/30"
            ...
            <p className="text-center text-sm text-muted-foreground">
              ...
              <Link to="/app/signup" className="text-primary font-semibold">Sign up</Link>
            </p>
          </div>
        </GlassCard>
      </div>
